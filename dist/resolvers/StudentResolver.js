...
let default_1 = class default_1 {
    ...
    getStudentsByClass(id) {
        return data_1.studentsDatas.filter(student => student.class_id === id);
    }
    ...
    //   }
    person(student) {
        return data_1.personDatas.find(person => {
            return person.id === student.person_id;
        });
    }
    class(student) {
        return data_1.classes.find(c => {
            return c.id === student.class_id;
        });
    }
};
__decorate([
    type_graphql_1.Query(returns => [Student_1.default]),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Object)
], default_1.prototype, "getStudentsByClass", null);
__decorate([
...
], default_1.prototype, "person", null);
__decorate([
    type_graphql_1.FieldResolver(),
    __param(0, type_graphql_1.Root()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], default_1.prototype, "class", null);
default_1 = __decorate([
    type_graphql_1.Resolver(of => Student_1.default)
], default_1);
